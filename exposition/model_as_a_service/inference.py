...
from dags.config import MODEL_PATH
...
def predict_endpoint():
    ...
    received_data_df['Ws1_avg'] = received_wind_speed_avg

    feat = prepare_features(data=received_data_df, training_mode = False)
    prediction = predict(feat, MODEL_PATH)['predictions']

    return jsonify(prediction.to_dict())

    #curl localhost:5000/predict?Ws1_avg=100